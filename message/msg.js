...
const nobot = "6288902971638" // Ganti No Bot Kalian
const namabot = "Kotori MD" // Ganti Nama Bot Kalian
const nameown = "SirKelBotzz" // Ganti Nama Kalian
const numown = "0882008356011" // Ganti Nomor Kalian
const nameowner = "AbilPut" // Ganti Nama Kalian
const footer = "K O T O R I" // Ganti Nama Bot Kalian
const capt = "*Kotori Minami*" // Ganti Nama Bot Kalian
const grup = "Not Found" // Ganti Link Group Kalian
const nomorown = "https://wa.me/62882008356011" // Ganti Nomor Kalian
const note = "*_Bot Ini Masih Dalam Pengembangan!!!_*" // Kalau Mau Ganti Aja

// Setting Donasi
const gopay = "0882-0083-56011" // Ganti Nomor Gopay Mu
const pulsa = "0882-0083-56011" // Ganti No Pulsa Mu
const insta = "Blm Ada" // Ganti Nama IG Mu
const github = "NaItzzBot" // Ganti Nama Github Mu
...
const nomor = "wa.me/62882008356011"
...
// Setting Payment 
const via = "ShoopePay, Qris, Gopay, Pulsa" // Terserah Mau Payment Apa Aja
...
module.exports = async(conn, msg, m, setting, store) => {
    ...
    const readmore = more.repeat(4001)
		...
		const buttonsDefault = [
			{ urlButton: { displayText: `Group Kotori Bot`, url : `${grup}` } },
...
conn.sendMessage(from, {caption: caption, fs.readFileSync('media/chris2.jpg')}, {quoted: msg})
break
			/*case prefix+'donate':
			case prefix+'donasi':
			    reply(`◪ DONASI
